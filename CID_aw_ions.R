...
write.csv(a.ions.frag.mass, 'output folder path/std_out_a_ions.csv') # Output folder path
write.csv(w.ions.frag.mass, 'output folder path/std_out_w_ions.csv') # Output folder path
q()