...
write.csv(b.ions.frag.mass, 'output folder path/std_out_b_ions.csv') # Output folder path
write.csv(x.ions.frag.mass, 'output folder path/std_out_x_ions.csv') # Output folder path
q()